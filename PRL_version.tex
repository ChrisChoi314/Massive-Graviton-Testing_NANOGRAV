...
\begin{figure*}[ht]
    ...
    \caption{The effective overlap reduction function plotted as a function of the angular separation $\xi$ between a pair of pulsars, for $|\boldsymbol{k}|/k_0 = 0.61$ in red and $|\boldsymbol{k}|/k_0 = 0.01$ in blue. The angular-separation–binned inter-pulsar correlations for NANOGrav15 are plotted with error bars in the left panel, and for CPTA DR1 in the right panel, for $f = 1/T_{\text{CPTA}}$. For both panels, we depict the HD correlation as a reference.}
    \label{fig:ng}
\end{figure*}
...
\begin{figure}[ht]
    ...
    \caption{The $\chi^2$/d.o.f.~fitting plotted as a function of the ratio $|\boldsymbol{k}|/k_0$.}
    \label{fig:chi}
\end{figure}
\begin{table}[ht]
\centering
...
\hline
\multirow{2}{*}{NANOGrav15} & HD & --  & 22.20 & 1.71 \\ \cline{2-5}
                           & MG & 0.61 & 6.59  & 0.55 \\ 
\hline
\multirow{2}{*}{CPTA DR1}  & HD & --  & 38.95 & 3.00 \\ \cline{2-5}
                           & MG & 0.01 & 16.58 & 1.35 \\ 
\hline
\end{tabular}
