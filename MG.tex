...
\begin{figure}[h]
    ...
    \caption{The frequency-dependent effective overlap reduction function plotted as a function of the angular separation $\xi$ between a pair of pulsars, in blue. This is plotted at the lower bound of the frequency, $1/T_{\text{CTPA}}$, and we set $|{\bf k}|/k_0 = 0.1$. The angular–separation–binned inter-pulsar correlations for the CPTA dataset for $1/T_{\text{CTPA}}$ are plotted with error bars. The bins are chosen to match the results of Ref.\ \cite{Xu:2023wog}, since their data are not public.}
    \label{fig:cpta}
\end{figure}
...
Our findings are surprising; they show that 
