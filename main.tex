...
The direct detection of GWs at high frequencies by interferometers \cite{LIGOScientific:2016aoc,LIGOScientific:2016sjg, KAGRA:2020agh, VIRGO:2014yos} and the more recent detection of the stochastic GW background (SGWB) \red{at low frequencies}, through various PTA collaborations \cite{Agazie:2023, Xu:2023wog,EPTA:2023sfo,EPTA:2023akd,EPTA:2023fyk, Zic:2023gta,Reardon:2023gzh}, have ignited further interest in GW astronomy, giving us the unique possibility of constraining fundamental physics and understanding the nature of gravity. 
In our study, we use data collected by NANOGrav \cite{Agazie:2023} to help us better understand gravity and connect MG to observables. 

In this \red{paper}, we derive the overlap reduction function (ORF) and the dispersion relation in ghost-free massive gravity, taking into account the effect of these extra polarization modes.
\red{In particular, we study the effect of the finite distance effect in the ORFs, which will be relevant when we leave in the pulsar terms in the integral.} Throughout this paper, we use natural units, setting $c = $$\ \hbar = $$\ k_B = $$\ 1$.

\section{Formalism}\label{sec:formalism} 
\subsection{Ghost-free massive gravity}\label{subsec:ghost_free} The following effects of MG on GWs have been \red{historically} used to place constraints on the graviton mass \cite{deRham:2016nuf}:

(i) \textit{Yukawa-like exponential suppression}---Yukawa suppression \red{of the gravitational potential} is expected when the force carrier possesses a nonzero mass \cite{Will:1997bb}. In the case of MG, suppression is of the form $\Phi \propto e^{-m_gR}/R$ \cite{Will:1997bb}, dependent on the length scale $R$. There is also a suppression of GWs at wavelengths larger than the Compton length scale of the graviton ($R_g \simeq m_g^{-1}$)\footnote{The length scale determined by the graviton mass through the Yukawa suppression can naively be treated as a ``gravitational causal horizon'', outside of which we expect the correlations of gravitational perturbations to be suppressed \cite{Will:1997bb}.}.
